    ...
    <main className="relative w-full min-h-screen bg-black text-white overflow-x-hidden scroll-smooth">
      ...
      <section className="relative w-full h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-20 flex flex-col items-center w-full h-full pt-[20.77vw] text-center">
          ...
          {/* Scroll Indicator — large circle with chevron + label inside */}
          <div className="flex items-center justify-center cursor-pointer opacity-80 hover:opacity-100 transition-opacity group">
            {/* The Circle Container */}
            <div className="relative flex flex-col items-center justify-center w-[12.5vw] h-[12.5vw]">
              {/* Fading Border Ring */}
              <div
                className="absolute inset-0 rounded-full border border-white/40 group-hover:border-white/70 transition-colors pointer-events-none"
                style={{
              ...
              <svg
                ...
                className="text-white mb-[1.2vw] relative z-10"
              >
                <path d="M6 9l6 6 6-6" />
              </svg>

              {/* Scroll Text */}
              <span className="font-manrope font-normal text-[0.833vw] leading-[1.2] tracking-[0.05em] text-white/80 relative z-10">
                Scroll
              </span>
            </div>
          </div>
